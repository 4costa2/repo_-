...
if (!localStorage.getItem("proporcionesPared")) {
...
function ajustarProporciones() {
    ...
    localStorage.setItem(
        "proporcionesPared",
        JSON.stringify(proporcionesPared),
    );
...
function mostrarProporcionesActuales() {
    const proporcionesPared = JSON.parse(
        localStorage.getItem("proporcionesPared"),
    ) || {
        arena: 7,
        cemento: 2,
    ...
    document.getElementById("arenaDato").textContent = proporcionesPared.arena;
    document.getElementById("cementoDato").textContent =
        proporcionesPared.cemento;
}
